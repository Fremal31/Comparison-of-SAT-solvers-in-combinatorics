...
int main(int argc, char **argv) {
    try {
        ...
        Factory factory;
        Graph G = ba_graph::internal_graph6::is_sparse6_format(g6)
            ? ba_graph::internal_graph6::read_sparse6_strict(g6, factory)
            : ba_graph::internal_graph6::read_graph6_strict(g6, factory);
